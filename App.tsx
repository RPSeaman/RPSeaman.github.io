  ...
  return (
    <div className="min-h-screen bg-bg-primary selection:bg-accent-teal/30 selection:text-white relative bg-dot-grid">
      ...
      <div className="spheres-wrapper">
        ...
        <motion.div style={{ y: y1 }} className="fixed top-[12%] left-[18%] w-32 h-32 rounded-full bg-gradient-to-br from-cyan-400/40 to-teal-600/20 border border-cyan-400/35 shadow-[0_0_25px_rgba(34,211,238,0.15)] pointer-events-none animate-float-1 z-0" />
        <motion.div style={{ y: y2 }} className="fixed top-[22%] left-[62%] w-24 h-24 rounded-full bg-gradient-to-br from-emerald-400/40 to-teal-500/20 border border-emerald-400/35 shadow-[0_0_20px_rgba(52,211,153,0.15)] pointer-events-none animate-float-2 z-0" />
        <motion.div style={{ y: y3 }} className="fixed top-[32%] right-[22%] w-40 h-40 rounded-full bg-gradient-to-tr from-pink-500/40 to-purple-600/20 border border-pink-400/35 shadow-[0_0_30px_rgba(244,63,94,0.15)] pointer-events-none animate-float-2 z-0" />
        <motion.div style={{ y: y4 }} className="fixed top-[45%] left-[10%] w-28 h-28 rounded-full bg-gradient-to-tr from-lime-400/35 to-emerald-500/15 border border-lime-400/30 shadow-[0_0_20px_rgba(163,230,53,0.12)] pointer-events-none animate-float-1 z-0" />
        <motion.div style={{ y: y1 }} className="fixed top-[52%] left-[40%] w-28 h-28 rounded-full bg-gradient-to-br from-amber-400/45 to-orange-500/30 border border-amber-400/45 shadow-[0_0_20px_rgba(251,191,36,0.18)] pointer-events-none animate-float-1 z-0" />
        <motion.div style={{ y: y2 }} className="fixed top-[62%] right-[10%] w-36 h-36 rounded-full bg-gradient-to-br from-red-500/35 to-amber-500/15 border border-red-400/30 shadow-[0_0_25px_rgba(239,68,68,0.12)] pointer-events-none animate-float-2 z-0" />
        <motion.div style={{ y: y3 }} className="fixed top-[70%] left-[20%] w-36 h-36 rounded-full bg-gradient-to-tr from-violet-500/40 to-indigo-600/20 border border-violet-400/35 shadow-[0_0_25px_rgba(139,92,246,0.15)] pointer-events-none animate-float-2 z-0" />
        <motion.div style={{ y: y4 }} className="fixed top-[82%] right-[32%] w-32 h-32 rounded-full bg-gradient-to-tr from-blue-500/40 to-indigo-600/20 border border-blue-400/35 shadow-[0_0_25px_rgba(59,130,246,0.15)] pointer-events-none animate-float-1 z-0" />
      </div>
